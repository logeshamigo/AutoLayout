...
//  AutoLayout
//
//  Created by Logesh on 11/10/15.
//  Copyright (c) 2015 GTALabs. All rights reserved.
//
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    switch (indexPath.row) {
        case 0:
            cell.textLabel.text = @"Equal Height";
            break;
        case 1:
            cell.textLabel.text = @"Equal Width and Height";
            break;
        case 2:
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    switch (indexPath.row) {
        case 0:
           [self performSegueWithIdentifier:@"equalHeights" sender:self];
            break;
        case 1:
            [self performSegueWithIdentifier:@"equalWidthAndHeight" sender:self];
            break;
        case 2:
            [self performSegueWithIdentifier:@"diagnolBoxes" sender:self];
            break;
        case 3:
